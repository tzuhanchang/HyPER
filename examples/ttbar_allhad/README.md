...
We provide a reconstruction script for the all hadronic $t\bar{t}$ events: `HyPER/topology/ttbar.py`, which is used when user request `topology=ttbar_allhad` in the configuration file:
```
